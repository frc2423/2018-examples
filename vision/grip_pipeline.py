...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_saturation = [92.0, 255.0]
    ...
    def process(self, source0):
        ...
        (self.cv_resize_output) = self.__cv_resize(self.__cv_resize_src, self.__cv_resize_dsize, self.__cv_resize_fx,
                                                   self.__cv_resize_fy, self.__cv_resize_interpolation)
